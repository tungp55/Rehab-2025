...
# gt_path = "C:/Users/Administrator/Desktop/Linh tinh/Dataset/HoneyBee2_annotations/"
# track_path = "C:/Users/Administrator/Desktop/Linh tinh/Dataset/dataset/HoneyBee1_annotations/"
# path_txt = "C:/Users/Administrator/Desktop/Linh tinh/Dataset/yolov5/yolov5-sort/track_sum.txt"
# gt_path = "C:/Users/Administrator/Desktop/Linh tinh/Dataset/GH010371_annotations/"
# track_path = "C:/Users/Administrator/Desktop/Linh tinh/Dataset/GH010371_annotations_copy/"
gt_path = "F:/MITICA/merge tracks/GH010371_170_290_tay_bac_sy/GH010371_170_290_gt/"
track_path = "F:/MITICA/merge tracks/GH010371_170_290_tay_bac_sy/GH010371_merge_tracks_2_hands/"
GT = 0
sum_FP = 0
sum_FN = 0
num_match = 0
...
def calc_conditions(gt_boxes, pred_boxes, iou_thresh, id_switches):
...
for i in range(len(gt_json_name_list)):
    ...
    TP, FP, FN, id_switches = calc_conditions(gt_boxes_list, track_boxes_list, iou_thresh=0.5, id_switches=id_switch)
    # print(i)
    # print("tp :", TP)
    # print("fp :", FP)
    # print("fn :", FN)
    ...
    for gt_label in gt_label_list1:
        ...
        for track_label in track_label_list1:
            if track_label == gt_label:
                ...
                box_track = [y for y in track_boxes_list1 if y[0] == gt_label]
                # print(box_gt)
                # print(box_track)
                overlap += 1 - bb_intersection_over_union(box_gt[0], box_track[0])
...
gt_label_list = list(set(gt_label_list))
# error = (len(track_label_list) - 8) * 2
# num_match += error
print("id_switch : ", id_switch)
print("sum_FP : ", sum_FP)
print("sum_FN : ", sum_FN)
print("GT : ", GT)
print("max :", max(track_label_list))
# print(track_label_list)
# print(len(gt_label_list))
# print(len(track_label_list))
# MOT_A = round((1 - (sum_FN + sum_FP + id_switch - error) / GT) * 100, 2)
MOT_A = round((1 - (sum_FN + sum_FP + id_switch) / GT) * 100, 2)
# MT += len(track_label_list) - id_switch
if num_match > 0:
